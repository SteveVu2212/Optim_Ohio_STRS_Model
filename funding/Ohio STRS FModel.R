...
for(i in StartIndex:length(FYE)){
  ...
  ER_NC_DB_CurrentHires_Pct[i] <- ERContribDB_CurrentHire - AmoRate_Stat_DB_CurrentHires
  ER_NC_Combined_CurrentHires_Pct[i] <- ERContribCombined_CurrentHire - AmoRate_Stat_Combined_CurrentHires
  ER_NC_DB_NewHires_Pct[i] <- ERContribDB_NewHire - AmoRate_Stat_DB_NewHires
  ER_NC_Combined_NewHires_Pct[i] <- ERContribCombined_NewHire - AmoRate_Stat_Combined_NewHires
  
  EE_NC_DB_CurrentHires_Pct[i] <- EEContribDB_CurrentHire + ER_NC_DB_CurrentHires_Pct[i]
  EE_NC_Combined_CurrentHires_Pct[i] <- EEContribCombined_DB_Transfer_CurrentHire + ER_NC_Combined_CurrentHires_Pct[i]
  EE_NC_DB_NewHires_Pct[i] <- EEContribDB_NewHire + ER_NC_DB_NewHires_Pct[i]
  EE_NC_Combined_NewHires_Pct[i] <- EEContribCombined_DB_Transfer_NewHire + ER_NC_Combined_NewHires_Pct[i]
  
  if(ER_Policy == 'Statutory Rate'){
    AmoRate_CurrentHires[i] <- (AmoRate_Stat_DB_CurrentHires*DBPayroll_CurrentHires[i] + 
                                  AmoRate_Stat_Combined_CurrentHires*CombinedPlanPayroll_CurrentHires[i] + 
    ...
    AmoRate_NewHires[i] <- (AmoRate_Stat_DB_NewHires*DBPayroll_NewHires[i] + 
                              AmoRate_Stat_Combined_NewHires*CombinedPlanPayroll_NewHires[i] + 
