...
FileName <- "Return and Correlation Data SERS.xlsx"
NumberofYears <- 20
...
write_excel_csv(as.data.frame(ProbabilityTab), 'Return Probabilities SERS.csv',col_names = FALSE)
write_excel_csv(as.data.frame(SimulationData), 'Simulation Data SERS.csv')
